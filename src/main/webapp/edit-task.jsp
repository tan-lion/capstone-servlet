						...
						<div class="white-box">
							<form action="update-task" method="post"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" placeholder="Tên công việc"
											class="form-control form-control-line" name="name" value="<%=task.getName() %>">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date"
											class="form-control form-control-line" name="start-date" value="<%=task.getStartDate() %>">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" 
											class="form-control form-control-line" name="end-date" value="<%=task.getStartDate() %>">
									</div>
								</div>
								<div class="form-group">
