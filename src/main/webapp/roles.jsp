			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="add-role" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
									...
									<tbody>
										<c:forEach var="role" items="${roles}">
											<tr>
												...
												<td>
													<a href="edit-role?id=${role.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="delete-role?id=${role.id }" class="btn btn-sm btn-danger">Xóa</a>
												</td>
											</tr>
										</c:forEach>
