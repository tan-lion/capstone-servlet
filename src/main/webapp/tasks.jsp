			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="add-task" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
									...
									<tbody>
										<c:forEach var="task" items="${tasks}">
											<tr>
												...
												<td>
												<a href="edit-task?id=${task.id}" class="btn btn-sm btn-primary">Sửa</a>
												<a href="delete-task?id=${task.id}" class="btn btn-sm btn-danger">Xóa</a> 
												<a href="detail-task" class="btn btn-sm btn-info">Xem</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
