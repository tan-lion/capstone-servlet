			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="add-job" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
									...
									<tbody>
										<c:forEach var="job" items="${jobs}">
											<tr>
												<td>${job.id}</td>
												<td>${job.name}</td>
												<td><fmt:formatDate value="${job.startDate}" pattern="dd/MM/yyyy"/></td>
												<td><fmt:formatDate value="${job.endDate}" pattern="dd/MM/yyyy"/></td>
												<td><a href="edit-job?id=${job.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="delete-job?id=${job.id}" class="btn btn-sm btn-danger">Xóa</a> <a
													href="detail-jobs" class="btn btn-sm btn-info">Xem</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
